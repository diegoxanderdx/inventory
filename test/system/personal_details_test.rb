...
class PersonalDetailsTest < ApplicationSystemTestCase
  ...
  test "should create personal detail" do
    ...
    fill_in "First name", with: @personal_detail.first_name
    fill_in "Id number", with: @personal_detail.id_number
    fill_in "Id type", with: @personal_detail.id_type
    fill_in "Last name", with: @personal_detail.last_name
    fill_in "Phone number", with: @personal_detail.phone_number
    fill_in "User", with: @personal_detail.user_id
    fill_in "Username", with: @personal_detail.username
