...
class MaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material" do
    assert_difference("Material.count") do
      post materials_url, params: { material: { category_id: @material.category_id, name: @material.name } }
    end
  ...
  test "should update material" do
    patch material_url(@material), params: { material: { category_id: @material.category_id, name: @material.name } }
